...
export const resolve = () => {
    handlePromise.resolve && handlePromise.resolve('DATA')
}
export const reject = () => {
...
Promise.all([pr1, pr2, pr3]).then(([res1, res2, res3]) => {
    // @ts-ignore
    console.log({...res1, ...res2, ...res3})
    // @ts-ignore
    console.log(Object.keys({...res1, ...res2, ...res3}))
})